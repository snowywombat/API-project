  ...
  async up (queryInterface, Sequelize) {
    for (let reviewImageInfo of reviewImages) {
      ...
      const foundReview = await Review.findOne({
        where: { review: reviewImageInfo.rev }
      });
